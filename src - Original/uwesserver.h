...
void make_HTML02() {
  ...
  if(farbe==LOW) //Farbe hin und her schalten, als Quittung fürs Absenden
    if (currentSwitchState)
      strcat( puffer, "<body bgcolor=\"#d6f7ab\">");    //grün-gelb
    else  
      strcat( puffer, "<body bgcolor=\"#fc9a8d\">");    //rot-gelb
  else 
    if (currentSwitchState)
      strcat( puffer, "<body bgcolor=\"#abf7c9\">");    //grün-blau
    else  
      strcat( puffer, "<body bgcolor=\"#fc8da7\">");    //rot-blau

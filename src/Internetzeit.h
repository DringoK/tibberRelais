...
const char *wochentag[]={"So", "Mo", "Di", "Mi", "Do", "Fr", "Sa", "So"};
...
//*********************************************************************************
//Aufrufen in main.setup(), um Server-Verbindung zu initialisieren
void initTime(){
...
//*********************************************************************************
void serialPrintlnTime(){
  Serial.printf("%s, %02d.%02d.%04d %02d:%02d:%02d\n",wochentag[tm.tm_wday],tm.tm_mday,tm.tm_mon,tm.tm_year,tm.tm_hour,tm.tm_min,tm.tm_sec);
}

//*********************************************************************************
void serialPrintTimeShort(){
